...
<head>
  ...
  <body text-align:center>
    ...
    <h1 align = "center"><strong>DĚTSKÁ HŘIŠTĚ</strong></h1>
    <p>
      <img id="borderimg1" src = "IMG_0612.jpeg" alt = "Dětská hřiště" width = 25% ><img id="borderimg1" src = "IMG_0502.jpeg" alt = "Dětská hřiště" width = 50%><img id="borderimg1" src = "IMG_0592.jpeg" alt = "Dětská hřiště" width = 25% >
    </p>
    <p align ="center"> 
      <select>
      ...
      <button type ="submit" name="search"><Strong>Hledat </Strong><i class="fas fa-search"></i></button>
    </p>
